...
class RsConsoleRunner(project: Project, title: String) :
    ...
    private val commandLine: GeneralCommandLine? = createCommandLine()
    ...
    private fun createCommandLine(): GeneralCommandLine? {
        ...
        val workingDir = cargoProject?.workingDirectory ?: return null
        return project.toolchain?.evcxr()?.createCommandLine(workingDir.toFile())
    }
